...
//		mLayoutTable.forceLayout();
	...
	public void setUpView() {
		...
		fieldPrezzo.setText(Util.getAsElahNumFormatForDetails(String.valueOf(unitprice))+" €");
		fieldScontoCanvas.setText(Util.getAsElahNumFormatForDetails(String.valueOf(discount))+" %");
		fieldScontato.setText(Util.getAsElahNumFormatForDetails(String.valueOf(prezzoScontao))+" €");
		fieldPromo.setText(Util.getAsElahNumFormatForDetails(String.valueOf(finalprice))+" €");
	...
	public void setUpDiscountOnly(IDiscount discountItem) {
		...
		fieldPrezzo.setText(Util.getAsElahNumFormatForDetails(discountItem.getUItem())+" €");
		fieldScontoCanvas.setText(Util.getAsElahNumFormatForDetails(discountItem.getDiscount())+" %");
		fieldScontato.setText(Util.getAsElahNumFormatForDetails(discountItem.getUItem())+" €");
		fieldPromo.setText("");
	}
