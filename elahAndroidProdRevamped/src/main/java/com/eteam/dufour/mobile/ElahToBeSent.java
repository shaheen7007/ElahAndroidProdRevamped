...
public class ElahToBeSent extends FragmentActivity implements 
	OnCheckedChangeListener,LoaderCallbacks<Cursor>, OnClickListener{
	// ===========================================================
	// Constants
	// ===========================================================
	...
	private void setEscPopUp() {
		...
		mPopUpEsc.setHeight(147);
		mPopUpEsc.setWidth(227);
	...
	public void setUpAdapters(int checkId) {
		...
		getSupportLoaderManager().restartLoader(checkId, null, this);
		...
		protected void onPostExecute(Integer result) {
	        ...
	        switch (result) {
				...
				case SURVEY_SEND_FAILURE:
					...
					if(ElahToBeSent.this!=null)
						getSupportLoaderManager().restartLoader(mBtnSegmented.getCheckedRadioButtonId(), null, ElahToBeSent.this);
					break;
	...
	private TextWatcher mSearchWatcher = new TextWatcher() {
		...
		public void afterTextChanged(Editable s) {
			...
			if(s.toString()!=null){
				...
				if(id!=-1)
					getSupportLoaderManager().restartLoader(id
