...
//	}
	...
	public static JSONArray getSurveyAsJSON(boolean isNew,long promotionId) throws JSONException{
		...
		Cursor c = getDB().query(TableSurveyPromotionsItem.TABLE_NAME, 
				new String[]{TableSurveyPromotionsItem.COLUMN_ID,TableSurveyPromotionsItem.COLUMN_SURVEY_PROMOTION_ID
				,TableSurveyPromotionsItem.COLUMN_ITEM_CODE,TableSurveyPromotionsItem.COLUMN_ITEM_DESC
				,TableSurveyPromotionsItem.COLUMN_ITEM_MARCHIO,TableSurveyPromotionsItem.COLUMN_ITEM_LINEA
				,TableSurveyPromotionsItem.COLUMN_ITEM_MACROFAMIGLIA,TableSurveyPromotionsItem.COLUMN_SURVEY_VOLANTINO
				,TableSurveyPromotionsItem.COLUMN_SURVEY_PREZZO,TableSurveyPromotionsItem.COLUMN_UNIQUE_FIELD
