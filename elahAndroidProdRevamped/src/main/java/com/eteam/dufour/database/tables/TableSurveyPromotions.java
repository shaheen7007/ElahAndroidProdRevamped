...
//		Log.d("Log", "Population started for "+surveyId+"in Prodotti Survey operation");
		Cursor c = getDB().query(TableSurveyPromotions.TABLE_NAME, 
				new String[]{TableSurveyPromotions.COLUMN_ID,TableSurveyPromotions.COLUMN_SURVEY_ID
				,TableSurveyPromotions.COLUMN_PROMOTION_CODE,TableSurveyPromotions.COLUMN_PROMOTION_SELL_IN
				,TableSurveyPromotions.COLUMN_PROMOTION_SELL_OUT,TableSurveyPromotions.COLUMN_SURVEY_VISIBILITY
				,TableSurveyPromotions.COLUMN_UNIQUE_FIELD,TableSurveyPromotions.COLUMN_SURVEY_MODIFY, COLUMN_FLAG}, 
				TableSurveyPromotions.COLUMN_SURVEY_ID+"="+surveyId, null, null, null, null);
