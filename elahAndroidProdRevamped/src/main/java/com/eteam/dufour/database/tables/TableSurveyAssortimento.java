...
//				idsToDelete = String.valueOf(id);
	...
	public static String[] getConvergeColumns(){
		if(convergeColumns==null){
			convergeColumns = new String[]{TableSurveyAssortimento.COLUMN_ID
...
//		Log.d("Log", "Population started for "+surveyId+"in Prodotti Survey operation");
		Cursor c = getDB().query(TableSurveyAssortimento.TABLE_NAME, 
				new String[]{TableSurveyAssortimento.COLUMN_ID
							...
							,TableSurveyAssortimento.COLUMN_ITEM_CODE,TableSurveyAssortimento.COLUMN_ITEM_DESC
				,TableSurveyAssortimento.COLUMN_ITEM_MARCHIO,TableSurveyAssortimento.COLUMN_ITEM_LINEA
				,TableSurveyAssortimento.COLUMN_ITEM_MACROFAMIGLIA,TableSurveyAssortimento.COLUMN_SURVEY_PREZZO
				,TableSurveyAssortimento.COLUMN_SURVEY_PREZZO_PROMO
				,TableSurveyAssortimento.COLUMN_SURVEY_FACING,TableSurveyAssortimento.COLUMN_SURVEY_LINEA
				,TableSurveyAssortimento.COLUMN_SURVEY_FUORI_BANCO,TableSurveyAssortimento.COLUMN_SURVEY_LEVEL
				,TableSurveyAssortimento.COLUMN_UNIQUE_FIELD,TableSurveyAssortimento.COLUMN_SURVEY_ASSORT_MODIFY}, 
				TableSurveyAssortimento.COLUMN_SURVEY_ID+"="+surveyId, null, null, null, null);
...
//			Log.d(TAG, "Changing facing value "+facing);
		...
		public void setAssorti(int assorti) {
			...
			pcs.firePropertyChange(COLUMN_SURVEY_LEVEL
					, oldValue, assorti);
		}
		...
		public JSONObject getAsJson() throws JSONException{
			...
			survey.put(TableSurveyAssortimento.COLUMN_SURVEY_FUORI_BANCO, fb);
