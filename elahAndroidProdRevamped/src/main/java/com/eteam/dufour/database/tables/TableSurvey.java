...
public class TableSurvey extends DBTable{
	...
	public static final Survey getSurvey(long surveyId){
		Cursor c = getDB().query(TableSurvey.TABLE_NAME, new String[]{COLUMN_SURVEY_SENT_DATE,COLUMN_SURVEY_SYNC_DATE
				,COLUMN_CUSTOMER_CODE,COLUMN_SALESPERSON_CODE,COLUMN_SALESPERSON_NAME,COLUMN_SURVEY_POST_STATUS,COLUMN_SURVEY_DATE,COLUMN_SURVEY_CLUSTER, COLUMN_SURVEY_CLUSTER_STATUS,COLUMN_ID
	...
	public static JSONObject getSurveyAsJSON(long surveyId,boolean isNewSurvey) throws JSONException{
		...
		Cursor c = getDB().query(TABLE_NAME, 
				...
				,COLUMN_SURVEY_SENT_DATE,COLUMN_SURVEY_CLUSTER,COLUMN_SURVEY_CLUSTER_STATUS,COLUMN_UNIQUE_ID,COLUMN_FLAG}, 
	...
	public static final void updateSurveySentDate(long surveyId,String sendDate,int clustValue, int clustStatus){
		ContentValues values = new ContentValues();
...
//	}
	...
	public static class Survey extends BaseSurvey{
		...
		public Survey(String salesPersonCode,String customerCode
				, String sentDateTime,int cluster,int clustStatus) {
			this(salesPersonCode, customerCode, sentDateTime,
					0, TableSyncInfo.getSyncDate(),cluster,clustStatus);
		}
		
		public Survey(String salesPersonCode,String customerCode
				,int flag, String sentDateTime,int cluster,int clustStatus) {
		...
		public Survey(String salesPersonCode,String customerCode
				, String sentDateTime
				, int postStatus,int cluster, int clustStatus) {
			this(salesPersonCode, customerCode, sentDateTime,
					postStatus, TableSyncInfo.getSyncDate(),cluster,clustStatus);
		}
		
		public Survey(String salesPersonCode,String customerCode
				, String sentDateTime
				, int postStatus,String syncDate,int cluster,int cluststatus) {
			this(salesPersonCode, customerCode,
					sentDateTime, FLAG_NEW_SURVEY,
					postStatus, syncDate,cluster,cluststatus);
		}
